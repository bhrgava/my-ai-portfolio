        ...
        <PasswordProtect correctPassword="Unlock123">
            <div className="bg-white">
                ...
                <Section id="hero" className="items-start pt-40 relative overflow-hidden">
                    {/* Dan Flavin Installation: "The Tatlin Tower" */}
                    <div className="absolute inset-0 z-0 pointer-events-none opacity-60">
                        <div className="absolute top-[20%] right-[10%] flex flex-col items-end gap-4">
                            <div className="w-16 h-2 bg-white shadow-[0_0_20px_rgba(251,191,36,1),0_0_60px_rgba(251,191,36,0.8)]"></div>
                            <div className="w-32 h-2 bg-white shadow-[0_0_20px_rgba(251,191,36,0.8),0_0_60px_rgba(251,191,36,0.6)]"></div>
                            <div className="w-48 h-2 bg-white shadow-[0_0_20px_rgba(251,191,36,0.6),0_0_60px_rgba(251,191,36,0.4)]"></div>
                            <div className="w-64 h-2 bg-white shadow-[0_0_20px_rgba(251,191,36,0.4),0_0_60px_rgba(251,191,36,0.2)]"></div>
                        </div>
                        <div className="absolute top-0 right-[20%] w-2 h-full bg-white shadow-[0_0_30px_rgba(255,255,255,1),0_0_100px_rgba(255,255,255,1)]"></div>
                    </div>

                    <div className="relative z-10">
                        <div className="inline-block mb-6 px-3 py-1 border border-slate-900 bg-white text-slate-900 text-xs font-mono uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(245,158,11,1)]">
                            Strategy Definition
                        </div>

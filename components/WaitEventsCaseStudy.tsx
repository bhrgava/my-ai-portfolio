        ...
        <div className="bg-white">
            ...
            <Section id="hero" className="items-start pt-40 relative overflow-hidden">
                <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                    ...
                    <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-full bg-gradient-to-tl from-purple-500 to-rose-400 opacity-20 mix-blend-multiply -rotate-12" />
                </div>
            ...
            <Section id="audit" title="The Gap" subtitle="01 / Analysis">
                <div className="border-2 border-slate-900 bg-white p-12 relative shadow-[4px_4px_0px_0px_rgba(236,72,153,1),8px_8px_0px_0px_rgba(147,51,234,1)]">
                    {/* Background Grid */}
